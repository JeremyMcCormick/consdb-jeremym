...
Revision ID: d1a1769f89b8
Revises: 0490d793fc1a
Create Date: 2024-11-13 14:05:02.710901+00:00
...
def downgrade() -> None:
    ...
    op.drop_table("visit1", schema="cdb_lsstcomcam")
    op.drop_table("ccdvisit1", schema="cdb_lsstcomcam")
    # ### end Alembic commands ###
