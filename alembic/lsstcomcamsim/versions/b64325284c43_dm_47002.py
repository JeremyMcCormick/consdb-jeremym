...
Revision ID: b64325284c43
Revises: cff7da7ec8ed
Create Date: 2024-11-13 14:05:04.731839+00:00
...
def downgrade() -> None:
    ...
    op.drop_table("visit1", schema="cdb_lsstcomcamsim")
    op.drop_table("ccdvisit1", schema="cdb_lsstcomcamsim")
    # ### end Alembic commands ###
